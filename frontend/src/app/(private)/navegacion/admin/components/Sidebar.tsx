...
import { 
  ...
  HelpCircle // 🚀 1. IMPORTAMOS EL ÍCONO DE AYUDA AQUÍ
} from 'lucide-react';
  ...
  const menuGroups = useMemo(() => [
      ...
      },
      {
          ...
          items: [
              ...
              { name: 'Ajustes', href: `${basePath}/config`, icon: Settings },
              { name: 'Ayuda', href: `${basePath}/ayuda`, icon: HelpCircle }, // 🚀 2. AGREGAMOS EL LINK DE AYUDA AQUÍ
          ]
      },
  ], [basePath]);
